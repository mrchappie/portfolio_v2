              ...
              <div className={classes.education}>
                ...
                <div className={classes.eduContent}>
                  <ul>
                    ...
                    <li>
                      <EducationComp
                        education={ALEX_INFO.about.education.college.education}
                        institution={
                    ...
                    <li>
                      <EducationComp
                        ...
                        start={ALEX_INFO.about.education.hightSchool.date.start}
                        finished={
                          ALEX_INFO.about.education.hightSchool.date.finished
                        }
                        city={ALEX_INFO.about.education.hightSchool.city}
                        country={ALEX_INFO.about.education.hightSchool.country}
                        faculty={ALEX_INFO.about.education.hightSchool.faculty}
                        specialization={
